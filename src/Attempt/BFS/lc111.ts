...
const minDepthBruteForce = (root: TreeNode | null): number => {
  return 0
}

const minDepthNaiveImp = (root: TreeNode | null): number => {
  return 0
}

const minDepthNaiveDec = (root: TreeNode | null): number => {
  return 0
}

const minDepthOptimal = (root: TreeNode | null): number => {
  return 0
}
